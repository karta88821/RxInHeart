...
private extension InfoHeaderView {
    ...
    func initUI() {
        ...
        titleLabel.setup(textAlignment: .left, fontSize: 15, textColor: grayColor)
        let attributeString = NSAttributedString(string: "編輯",
                                                 attributes: [.font: UIFont.systemFont(ofSize: 15),.foregroundColor: darkRed!])
